...
namespace commPinPad.Pages
{
	public class Pinpad
	{
        ...
        protected static string comando_72()
        {
            string salida1 = "";
            string hexString = "";
        ...
        public static string getDatosEX(string factMessage)
        {
        ...
        public static string comando_C50(string monto)
        {
            string salida1 = "";
            string hexString = "";
            string parametros = "";
            ...
            string com_TransDate = Utils.getDate();  // "23 06 22";  // Representa cualquier fecha válida (22 de jun de 2023)
                                               // a 6 dígitos en BCD en el formato YYMMDD
            string hexCom_TransDate = "";
            string com_TransTime = Utils.getTime();   // "18 18 00";  // Representa cualquier hora válida a 6
            ...
            longitud = Utils.longitudParametros(parametros);
        ...
        public static string comando_C51(string monto, string date, string time)
        {
            string salida1 = "";
            string hexString = "";
            string parametros = "";
        ...
        public static string comando_C54(string authId, string respCode, string AuthData)   //  Varios de los datos que se mandan en C54 deben ser recuperados del Host
        {
            string salida1 = "";
            string hexString = "";
            string parametros = "";
            ...
            string com_TransDate = Utils.getDate();   // "23 06 22";  // Representa cualquier fecha válida (1 de ago de 2022)
                                                // a 6 dígitos en BCD en el formato YYMMDD
            string hexCom_TransDate = "";
            string com_TransTime = Utils.getTime();   // "18 27 30";  // Representa cualquier hora válida a 6
                                                // Digitos en BCD en el formato HHMMSS  (4:27:00)
            string hexCom_TransTime = "";
        ...
        public static string comando_textScreen(string texto)
        {
            string STX = "02";  // Start of Text. Indica el inicio de un mensaje de datos.
            string ETX = "03";  // End of Text. Indica el fin de un mensaje de datos.
            string LRC = "";    // Longitudinal Redundancy Check Character.
            ...
            LRC = Utils.strAddXOR(hexString2);
            salida2 = STX + hexString2 + LRC;

            return salida1;
        }

        public static void generaLlave(string transId, string stan, string refNum)
        {
            string respuesta = "";
            string tokenEX = "";
            string mti = "0200";
            ...
            string datosRespCZ10 = Post.toHostNewKey(respuesta, transId, stan, refNum, mti, date, time);
        ...
        public static string enviarCodigos(string txtHexa)
        {
            ...
            if (serialPort1.IsOpen)
            {
                ...
                if (txtHexaSize > 2) { _continue = true; respuesta = Read(); }
        ...
        public static string comando_Z10_solicitarKeyGen()
        {
            string STX = "02";  // Start of Text. Indica el inicio de un mensaje de datos.
            string ETX = "03";  // End of Text. Indica el fin de un mensaje de datos.
            string LRC = "";    // Longitudinal Redundancy Check Character.
        ...
        public static string comando_Z11_insertarKeyGen(string tokenEX)
        {
            string STX = "02";  // Start of Text. Indica el inicio de un mensaje de datos.
            string ETX = "03";  // End of Text. Indica el fin de un mensaje de datos.
            string LRC = "";    // Longitudinal Redundancy Check Character.
        ...
        static void interpreteRespuesta(string respuesta)
        {
            ...
            if (continua)
            {
                ...
                switch (tipoMensaje)
                {
                    ...
                    case "C53":
                        enviarCodigos("06");
                        break;
                    case "C54": enviarCodigos("06");  break;
                }
            }
        ...
        static XtrPost getValuesRespC53(string respuestaC53)
        {
            ...
            if (continuar)
            {
                do
                {
                    ...
                    switch (initToken)
                    {
                        ...
                        case "226": //E2
                            ...
                            valuesC53[posC53] = initToken + " " + longToken + Utils.readShortToken(longToken, ref i, ref respList);
                            posC53++;
                            break;
                        case "193": //C1  
                            longToken = respList[i]; i++;
                        ...
                        case "33":  // !
                            ...
                            valuesC53[posC53] = Utils.readLongToken(ref i, ref respList);
                            posC53++;
                            break;
                        default:
                ...
                Console.WriteLine("** 6]TokenE1: " + valuesC53[6]);
                Console.WriteLine("** 7]TokenE2: " + valuesC53[7]);
        ...
        public static (string, string, string) readCode210(string resultCode210)
        {
            ...
            if (bin[2].ToString().Equals("1"))
            { /* C3  ProcessingCode F6 */
                fijo = 6;
                processingCode = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[3].ToString().Equals("1"))
            { /* C4  TransactionAmount F12 */
                fijo = 12;
                transactionAmount = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[6].ToString().Equals("1"))
            { /* C7  TransmissionDateTime F10 */
                fijo = 10;
                transmissionDateTime = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[10].ToString().Equals("1"))
            { /* C11  STAN F6 */
                fijo = 6;
            ...
            if (bin[14].ToString().Equals("1"))
            { /* C15  SettlementDate F4 */
                fijo = 4;
            ...
            if (bin[24].ToString().Equals("1"))
            { /* C25  PointOfService F2 */
                fijo = 2;
                pointService = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[31].ToString().Equals("1"))
            { /* C32  AcquiringInstCode V2:11 */
            ...
            if (bin[37].ToString().Equals("1"))
            { /* C38  AuthorizationIdResp F6 */
                fijo = 6;
                authorizationIdResp = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[38].ToString().Equals("1"))
            { /* C39  ResponseCode F2 */
                fijo = 2;
            ...
            if (bin[40].ToString().Equals("1"))
            { /* C41  CardAcceptorId F16 */
                fijo = 16;
                cardAcceptorId = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[42].ToString().Equals("1"))
            { /* C43  CardAcceptorName F40 */
                fijo = 40;
                cardAcceptorName = resultCode210.Substring(posResult, fijo);
                posResult += fijo;
            }

            if (bin[47].ToString().Equals("1"))
            { /* C48  AdditionalData V3:27 */
            ...
            if (bin[48].ToString().Equals("1"))
            { /* C49  TransactionCode F3 */
                fijo = 3;
            ...
            if (bin[54].ToString().Equals("1"))
            { /* C55  EMVFullGrade V3:999 */
            ...
            if (bin[59].ToString().Equals("1"))
            { /* C60  PosTerminalData V3:16 */
            ...
            if (bin[61].ToString().Equals("1"))
            { /* C62  PostalCode ANS13 */
            ...
            if (bin[62].ToString().Equals("1"))
            { /* C63  PosAditionalData V:999 */
            ...
            if (bin2[38].ToString().Equals("1"))
            { /* C103  AccountId2 V2:28 */
        ...
        static void getValuesC55(ref string token, ref int posc55, string c55EMVFullGrade, string tag)
        {
        ...
        static string getValuesRespZ10(string resp)
        {
            ...
            if (continuar)
            {
                do
                {
                    valuesZ10[posZ10] = Utils.readLongToken(ref i, ref respList);
                    posZ10++;
                    break;
